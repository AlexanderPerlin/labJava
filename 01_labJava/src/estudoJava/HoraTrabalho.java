/*
 2. Desenvolva um software em Java que leia o número de horas trabalhadas e
 o valor que recebe por hora. Calcule e escreva na tela o salário bruto deste
 funcionário.
 */
package estudoJava;
...
public class HoraTrabalho {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Seu salário bruto é R$" + resultado);
teclado.close();
    }
